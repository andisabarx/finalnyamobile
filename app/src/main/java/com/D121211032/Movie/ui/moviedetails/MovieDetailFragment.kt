package com.D121211032.Movie.ui.moviedetails
...
import com.D121211032.Movie.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtRating.text = "${args.voteAverage} (${args.voteCount} Revies)"
